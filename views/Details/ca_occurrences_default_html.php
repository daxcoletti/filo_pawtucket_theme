		...
		<div class="container">
			...
			<div class="row">			 
				<div class='col-sm-6 col-md-6 col-lg-6'>
					{{{<ifdef code="ca_occurrences.notes"><H6>Descripción</H6>^ca_occurrences.description<br/></ifdef>}}}
					{{{<ifdef code="ca_occurrences.premiere"><H6>Estreno</H6>^ca_occurrences.premiere<br/></ifdef>}}}
					{{{<ifdef code="ca_occurrences.venue"><H6>Lugar</H6>^ca_occurrences.venue<br/></ifdef>}}}
					{{{<ifdef code="ca_occurrences.productionDate"><H6>Fechas</H6>^ca_occurrences.productionDate<br/></ifdef>}}}
					...
					{{{<ifdef code="ca_occurrences.description"><H6>Descripción</H6>^ca_occurrences.description<br/></ifdef>}}}  
...
?>					
					...
					{{{<ifcount code="ca_occurrences.related.preferred_labels" restrictToTypes="production" min="1"><h6>Producciones relacionadas</h6><unit relativeTo="ca_occurrences.related" restrictToTypes="production" delimiter='<br/>'><l>^ca_occurrences.preferred_labels</l><ifdef code="ca_occurrences.productionDate">, ^ca_occurrences.productionDate</ifdef></unit></ifcount>}}}
					
					{{{<ifcount code="ca_entities.preferred_labels" restrictToRelationshipTypes="company" min="1"><h6>Compañía relacionada</h6><unit restrictToRelationshipTypes="company" relativeTo="ca_entities" delimiter='<br/>'><l>^ca_entities.preferred_labels</l></unit></ifcount>}}}
